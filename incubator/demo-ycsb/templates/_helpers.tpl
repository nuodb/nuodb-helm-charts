...
*/}}
{{- define "ycsb.name" -}}
{{- default .Chart.Name .Values.ycsb.nameOverride | trunc 63 | trimSuffix "-" -}}
{{- end -}}
...
{{- if .Values.ycsb.fullnameOverride -}}
{{- .Values.ycsb.fullnameOverride | trunc 63 | trimSuffix "-" -}}
{{- else -}}
{{- $name := default .Chart.Name .Values.ycsb.nameOverride -}}
...
{{/*
Return the proper YCSB image name
*/}}
{{- define "ycsb.image" -}}
{{- $registryName := .Values.ycsb.image.registry -}}
{{- $repositoryName := .Values.ycsb.image.repository -}}
{{- $tag := .Values.ycsb.image.tag | toString -}}
{{/*
...
{{- range .Values.global.imagePullSecrets }}
  - name: {{ . }}
{{- end }}
{{- else if .Values.ycsb.image.pullSecrets }}
imagePullSecrets:
{{- range .Values.ycsb.image.pullSecrets }}
  - name: {{ . }}
{{- end }}
{{- end -}}
{{- else if .Values.ycsb.image.pullSecrets }}
