...
| `te.k8sL4Service.enabled` | Whether to deploy a Layer 4 cloud load balancer service for the admin layer | `false` |
| `te.k8sL4Service.internalIP` | Whether to use an internal or external IP address for the load balancer | `nil` |
