...
if [[ "$REQUIRES_MINIKUBE" == "true" ]]; then
  ...
  # Download minikube.
  curl -Lo minikube https://github.com/kubernetes/minikube/releases/v"${MINIKUBE_VERSION}"/minikube-linux-amd64 && chmod +x minikube && sudo mv minikube /usr/local/bin/
